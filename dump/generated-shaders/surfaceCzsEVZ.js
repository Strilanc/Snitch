...
let surfaceCzsEVZ = new ParametrizedShader(`#version 300 es
    ...
    void main() {
        ...
        int add_5 = divide_2 + 1;
        int bitwise_or_6 = add_5 | 1;
        int sub_7 = bitwise_or_6 - 1;
        bool lt_8 = sub_7 < surface_height;
